...
As was previously said, the study case here is that of a thin wire anly excited by only an electric field along one direction. As can be seen in \Cref{fig:THINWIRE}, the magnetic field generated in such a configuration is consistent with the physical feeling
