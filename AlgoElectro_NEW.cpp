        ...
        for(size_t  K=1+IS_THE_FIRST_MPI_FOR_ELECRIC_FIELDZ; 
            ...
            for(size_t J=0; J<rhoY1; J++){  /* "-1" for the BC */
                for(size_t I=1; I<size_x-1-rhoX0-rhoX1; I++){
                    ...
                    // if( Ex[index] != 0){
                    //     printf(" size_x = %zu, size_y = %zu, size_z = %zu \n", size_x, size_y, size_z);
                    //     printf(" Ex_pml1 = %.40g , Ex_pml2 = %.40g , Hz[index_1Plus] = %.40g , Hz[index_1Moins] = %.40g , Hy[index_2Plus] = %.40g , Hy[index_2Moins] = %.40g \n ",
        ...
        for(size_t K=0; K<rhoZ1; K++){
            for(size_t  J=1+IS_THE_FIRST_MPI_FOR_ELECRIC_FIELDY;
                ...
                for(size_t  I=1+IS_THE_FIRST_MPI_FOR_ELECRIC_FIELDX; 
                    ...
                    //     Ex_pml_y1[index_pml],  Ex_pml_y1[index_pml+1], Hz[index_1Plus], Hz[index_1Moins], Hy[index_2Plus], Hy[index_2Moins]);
                    //     printf(" I = %zu, J = %zu, K = %zu \n ",I, J, K);
                    //     printf(" II = %zu, JJ= %zu KK = %zu\n ",II, JJ, KK);
                    //     printf(" C_eze = %lf, Ceze2 = %lf, C_ezh_1 = %lf, C_ezh_2 = %lf \n ", C_eze[index], C_eze2[index], C_ezh_1[index], C_ezh_2[index]);
                    // // }
                    //     if(K==rhoZ1-1){
                    //         printf(" K = %zu and rhoZ1-1 = %zu \n", K, rhoZ1-1);
                    //         abort();
                    //     }
...
{   
        ...
        for(size_t K=1; K<size_z-1; K++){
            for(size_t J=1; J<size_y-1; J++){
                for(size_t I=1; I<1+rhoX0; I++){
                    ...
                    //     printf(" size_x = %zu, size_y = %zu, size_z = %zu \n", size_x, size_y, size_z);
                    //     printf(" HX_pml1 = %lf , Hx_pml2 = %lf, Ey[index_1Plus] = %lf, Ey[index_1Moins] = %lf, Ez[index_2Plus] = %lf , Ez[index_2Moins] = %lf \n ",
    ...
    ////            // Hyx:
                    ...
                    //     printf(" size_x = %zu, size_y = %zu, size_z = %zu \n", size_x, size_y, size_z);
                    //     printf(" Hy_pml1 = %lf , Hy_pml2 = %lf, Ez[index_1Plus] = %lf, Ez[index_1Moins] = %lf, Ex[index_2Plus] = %lf , Ex[index_2Moins] = %lf \n ",
        ...
        for(size_t K=1; K<size_z-1; K++){
            for(size_t J=0; J<rhoY1; J++){ // We consider here J = 1 with J'=size_y-1-rhoY1 
                ...
                for(size_t I=1; I<size_x-1-rhoX0-rhoX1; I++){
                    ...
                    // if( Hy[index] !=0){
                    //     printf(" size_x = %zu, size_y = %zu, size_z = %zu \n", size_x, size_y, size_z);
                    //     printf(" Hy_pml1 = %.40g , Hy_pml2 = %.40g , Ez[index_1Plus] = %.40g , Ez[index_1Moins] = %.40g , Ex[index_2Plus] = %.40g , Ex[index_2Moins] = %.40g  \n ",
        ...
        for(size_t K=1; K<size_z-1; K++){
            for(size_t J=0; J<rhoY1; J++){ 
                for(size_t I=1; I<size_x-1-rhoX0-rhoX1; I++){
                    ...
                    // if( Hz[index] !=0){
                    //     printf(" size_x = %zu, size_y = %zu, size_z = %zu \n", size_x, size_y, size_z);
                    //     printf(" Hz_pml1 = %.40g , Hz_pml2 = %.40g , Ex[index_1Plus] = %.40g , Ex[index_1Moins] = %.40g , Ey[index_2Plus] = %.40g , Ey[index_2Moins] = %.40g  \n ",
