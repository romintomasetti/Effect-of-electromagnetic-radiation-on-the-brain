...
VTL_API_ROMIN void vtl_romin::export_polydata(std::string const &filename,
                             int step,
                             std::vector<double> const &pos,
                             std::map<std::string, std::vector<double> *> const &scalars,
                             std::map<std::string, std::vector<double> *> const &vectors,
...
VTL_API_ROMIN void vtl_romin::export_spoints_LEGACY(std::string const &filename,
...
VTL_API_ROMIN void vtl_romin::export_spoints_XMLP(std::string const &filename,
                                 int step,
                                 SPoints const &grid,
 ...
 */
VTL_API_ROMIN void vtl_romin::export_spoints_XMLP_custom_GridCreator_NEW(
 ...
 * 
 */
VTL_API_ROMIN void vtl_romin::export_spoints_XML_custom_GridCreator_NEW(
    std::string type /* THERMAL or ELECTRO */,
    std::string outputFileName,
    size_t currentStep,
    vtl_romin::SPoints &grid,
...
VTL_API_ROMIN void vtl_romin::export_spoints_XML_GridCreatorNew(
